...
try{
    ...
    var sq=/长春沈铁盛华庭|长春远东小区|长春温州城|长春太平洋鞋城（商）|长春五金市场散楼|长春双龙大厦|长春天津路高层|长春胜利大街小区|长春东三条社区|长春黄河路散楼|长春天津路小学家属楼|长春贵阳高层|长春贵阳小区|长春新发社区四期|长春新发社区三期|长春长白路社区|长春北京大街散楼/;
    var countIndent=0;
    //音乐audio对象
    ...
    setTimeout(function(){
     ...
     //   logIndent.innerHTML="插入来单音乐\n"+document.getElementById("logIndent").innerHTML;
        ...
        setTimeout(si,20000);
      /*  if(document.getElementById("userInfoName").innerHTML!="刘建楠"){
          window.location.href="http://map.baidu.com/detail?qt=ninf&detail=life&uid=ee9360631f22267343afe6b9&from=alamap&tpl=mapsite";
           window.close();
        }*/
 ...
 document.getElementById("logIndent").innerHTML+="社区查询中...\n";
           ...
           document.getElementsByTagName("audio")[0].src="http://culat.uicp.hk/voice/tts?text="+"接了"+sheq+"的工单"+"&isattachment=false";
        },3000);
        setTimeout(function(){
            if(checked){
                console.log("点击确定");
